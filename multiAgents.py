...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        "*** YOUR CODE HERE ***"
        #The strategy is to not go near the ghosts and eat food meanwhile escaping.
        newFood = successorGameState.getFood().asList()
        minFood = float("inf")
        for food in newFood:
            minFood = min(minFood, manhattanDistance(newPos, food))

        # Escape from ghost if it comes near
...
class ExpectimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        #util.raiseNotDefined()# calling expectimax with the depth we are going to investigate
    ...
    def maxval(self,gameState,action,depth,agentIndex):
        ...
        for legalAction in gameState.getLegalActions(agentIndex):
            ...
            successorValue = self.expectimax(gameState.generateSuccessor(agentIndex, legalAction),
